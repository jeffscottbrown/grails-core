...
Within your code, such as in a Gant script or a bootstrap class you can detect the environment using the link:{api}grails/util/Environment.html[Environment] class:
